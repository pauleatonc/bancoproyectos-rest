...
from .models import GoodPractices, GoodPracticesWebSource, GoodPracticesGalleryImage
...
class GoodPracticesResource(ModelResource):
    class Meta:
        model = GoodPractices

# Modelos tipo inline
class GoodPracticesGalleryImage(admin.TabularInline):
    model = GoodPracticesGalleryImage

class GoodPracticesWebSource(admin.TabularInline):
    model = GoodPracticesWebSource


# Modelos disponibles para editar en el admin
@admin.register(GoodPractices)
class InnovativeProjectsAdmin(ImportExportMixin, admin.ModelAdmin):
    resource_class = GoodPracticesResource
