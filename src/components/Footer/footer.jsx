    ...
    return (
      <footer className="content-always-on-display">
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-3 a11y-fonts-col-12"><img className="mw-100 mb-3" src="https://via.placeholder.com/170x80" />
              <p>La alternativa para digitalizar los trámites de la ciudadanía.</p>
              <p>Esta plataforma es administrada:</p><img className="mw-100 mb-3" src="https://via.placeholder.com/140x50" /><a className="py-0" href="www.digital.gob.cl">www.digital.gob.cl</a>
            </div>
        ...
        <div className="my-3">
  <button className="btn btn-primary btn-default-size" type="button">Visitas a La Moneda</button>
</div>
