      ...
      <div className="cols-12-extended column ml-3  mr-5">
        ...
        <Link to="/">
          <div className="col-10">
            <div id="lineBlue" />
            <div id="lineRed" />
            <p className="logo-subdere">Subsecretaría de Desarrollo Administrativo y Regional</p>
          </div>
        </Link>
        ...
        <ul className="navbar-nav mx-md-5 my-md-3 mx-4">
          ...
          <li className="d-none d-lg-block nav-item">
            <div className="toolbar with-read-speaker">
              <a className="btn-accesibilidad-m toolbar-behavior-contrast" href="#"><i className="cl cl-contrast"></i></a>
              <div className="toolbar-btn-group d-flex flex-row">
                <a className="btn-accesibilidad-m toolbar-behavior-decrease" href="#"><i className="cl cl-decrease-text"></i></a>
                ...
                <a rel="nofollow" accessKey="L" href="#">
                  <span className="rsbtn_left rsimg rspart">
                    <span className="btn-escuchar rsbtn_text d-flex align-items-center p-1">
                      <div className="toolbar-btn-icon-content p-1 mt-1">
          ...
          <li className="nav-item">
            <div className="toolbar-btn-group d-flex flex-row mx-2 text-center">
              <a className="btn-accesibilidad-s d-none d-lg-block toolbar-behavior-decrease text-uppercase text-underline" href="#">en</a>
              <a className="btn-accesibilidad-s d-none d-lg-block toolbar-behavior-increase mx-1" href="#"><i className="cl cl-login"></i></a>
            </div>
            <button className="btn-principal-s ml-4" type="button"><i className="cl cl-claveunica"/> <span className="text-underline mx-1">Iniciar sesión</span></button>
          </li>
        </ul>
...
const Navbar = () =>{  
  ...
  <>
    <div id="barraGris"></div>
    <nav className="container-fluid navbar navbar-light navbar-expand-lg">
      ...
      <div className="row">
        {/* Inicio sesion */}
        <button className="btn-principal-s ml-4" type="button">
      ...
      {/* Navegacion */}
      <div className="row mx-md-auto mx-lg-auto mx-xl-auto d-flex flex-column flex-md-row">
        <Link to="/" className="link text-black text-underline mx-md-3"> Inicio </Link>
        <Link to="/bancodeproyectos" className="link text-black text-underline mx-md-3"> Banco de Proyectos </Link>
        <Link to="/bancodeproyectos" className="link text-black text-underline mx-md-3"> Type something </Link>
        <Link to="/bancodeproyectos" className="link text-black text-underline mx-md-3"> Type something </Link>
